...
export default function Skeleton({ variant = "default", count = 1 }) {
  ...
  if (variant === "tall") return items.map((_, i) => (
    <div key={i} className="woo-skeleton-wave-group rounded-3xl overflow-hidden bg-white shadow-lg animate-pulse">
  ...
  if (variant === "wide") return items.map((_, i) => (
    <div key={i} className="woo-skeleton-wave-group flex gap-4 bg-white rounded-2xl p-4 shadow-md animate-pulse">
  ...
  return items.map((_, i) => (
    <div key={i} className="woo-skeleton-wave-group rounded-3xl overflow-hidden bg-white shadow-md animate-pulse">
