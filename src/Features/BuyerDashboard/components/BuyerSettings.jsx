...
export default function BuyerSettings() {
  ...
  return (
    <div className="space-y-6 max-w-2xl">
      <h2 className="text-xl font-black" style={{ color: colors.text.primary }}>
        Account Settings
      </h2>
      ...
      >
        ...
        <div>
          ...
          <p className="text-xs mt-1.5" style={{ color: colors.text.tertiary }}>
            JPG, PNG up to 2MB
          </p>
        </div>
      </motion.div>
      ...
      <Section title="Personal Information" icon="user" delay={0.05}>
        <Field label="Full Name" defaultValue={buyerName} />
        <Field
          label="Email Address"
          defaultValue={BUYER_PROFILE.email}
          type="email"
        />
        <Field
          label="Phone Number"
          defaultValue={BUYER_PROFILE.phone}
          type="tel"
        />
      </Section>
      ...
      <Section title="Preferences & AI" icon="sparkle" delay={0.12}>
        ...
        <Toggle
          ...
          desc="SMS and email notifications for deliveries"
          defaultVal={true}
        />
        <Toggle
          label="Promotions & Deals"
          desc="Receive exclusive offers tailored to you"
          defaultVal={false}
        />
      </Section>
