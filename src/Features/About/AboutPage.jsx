    ...
    >
      ...
      <section className="relative pt-48 pb-32 px-6 flex flex-col items-center justify-center text-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-5xl mx-auto">
          ...
          >
            Woosho is an AI-powered commerce platform that helps people
            discover, compare, and buy products faster and smarter.
          </motion.p>
          <motion.div
          ...
          >
            <Link
              to="/products"
              className="w-full sm:w-auto px-8 py-4 bg-white text-black font-bold uppercase tracking-widest text-sm hover:bg-blue-600 hover:text-white transition-colors"
            >
              Start Shopping
            </Link>
            <Link
              to="/seller"
              className="w-full sm:w-auto px-8 py-4 bg-transparent text-white border border-white/20 font-bold uppercase tracking-widest text-sm hover:border-white transition-colors"
            >
              Start Selling
            </Link>
          </motion.div>
      ...
      <section className="py-24 px-6 md:px-12 max-w-[1600px] mx-auto border-t border-white/5">
        ...
        <div className="stagger-grid grid md:grid-cols-3 gap-8">
          {PROBLEMS.map((prob, i) => (
            <div
              key={i}
              className="bg-zinc-900/50 border border-white/5 p-10 flex flex-col items-center text-center hover:bg-zinc-900 transition-colors"
            >
      ...
      <section className="py-24 px-6 md:px-12 max-w-[1600px] mx-auto border-t border-white/5">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          <div className="reveal-up">
            ...
            <h3 className="text-5xl md:text-6xl font-black uppercase tracking-tighter text-white mb-8">
            ...
            <div className="space-y-8">
              {[
                ...
                <div key={i} className="flex gap-6 items-start">
                  <div className="font-black text-3xl text-gray-700 leading-none">
                    {item.step}
                  </div>
                  <p className="text-xl text-gray-300 font-medium pt-1">
                    {item.text}
                  </p>
                </div>
              ))}
      ...
      <section className="py-24 px-6 md:px-12 max-w-[1600px] mx-auto border-t border-white/5">
        <div className="reveal-up text-center mb-16">
          <h2 className="text-4xl md:text-6xl font-black uppercase tracking-tighter text-white max-w-3xl mx-auto leading-none">
            Not a Marketplace.
            <br />
            <span className="text-gray-500">A Decision System.</span>
          </h2>
        </div>
        <div className="stagger-grid grid md:grid-cols-2 lg:grid-cols-5 gap-4">
          {DIFFERENCES.map((diff, i) => (
            <div
              key={i}
              className="bg-zinc-900/30 border border-white/5 p-8 flex flex-col hover:bg-zinc-900 transition-colors"
            >
      ...
      <section className="py-32 px-6 md:px-12 max-w-[1600px] mx-auto relative overflow-hidden flex flex-col items-center justify-center text-center">
        <div className="reveal-up relative z-10 max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-400 font-medium leading-relaxed">
            ...
            long-term vision of becoming a global AI commerce infrastructure
            layer powering smarter retail experiences everywhere.
          </p>
        </div>
      </section>
      ...
      <section className="py-32 px-6 text-center border-t border-white/5 bg-zinc-900/20">
        <div className="reveal-up max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              to="/products"
              className="w-full sm:w-auto px-10 py-5 bg-white text-black font-bold uppercase tracking-widest text-sm hover:bg-blue-600 hover:text-white transition-colors"
            >
              Start Shopping Smarter
            </Link>
            <Link
              to="/seller"
              className="w-full sm:w-auto px-10 py-5 bg-transparent text-white border border-white/20 font-bold uppercase tracking-widest text-sm hover:border-white transition-colors"
            >
              Become a Seller
            </Link>
          </div>
          <div className="mt-8">
            <Link
              to="/analytics"
              className="text-sm font-bold text-gray-500 hover:text-white uppercase tracking-widest transition-colors flex items-center justify-center gap-2"
            >
