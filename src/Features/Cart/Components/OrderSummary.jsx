      ...
      {promo ? (
        ...
        >
          <div className="flex items-center gap-2">
            ...
            <span className="text-emerald-500 dark:text-emerald-500/80 text-xs">
              - {promo.label}
            </span>
          </div>
          <button
            type="button"
            onClick={onRemove}
            className="text-emerald-400 dark:text-emerald-500 hover:text-red-400 dark:hover:text-red-400 transition-colors"
          >
            <Ic.Close c="w-4 h-4" />
          </button>
        </motion.div>
