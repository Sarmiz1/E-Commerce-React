  ...
  return (
    <div className="bg-white dark:bg-[#0D1421] rounded-3xl border border-gray-100 dark:border-white dark:border-[#0D1421]/10 shadow-md overflow-hidden animate-pulse">
      ...
      <div className="p-6 space-y-4">
        ...
        <div className="flex justify-between pt-4 border-t border-gray-100 dark:border-white dark:border-[#0D1421]/10">
          <div className="space-y-1.5">
            <div className="h-2 bg-gray-100 dark:bg-white/5 rounded w-16" />
            <div className="h-4 bg-gray-200 rounded w-28" />
          </div>
          <div className="space-y-1.5 items-end flex flex-col">
            <div className="h-2 bg-gray-100 dark:bg-white/5 rounded w-12" />
