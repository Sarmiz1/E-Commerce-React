...
const ProblemSection = () => {
  ...
  return (
    <section ref={sectionRef} className="w-full py-24 px-6 md:px-12 bg-neutral-50 dark:bg-white/9 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {problems.map((prob, i) => (
            <div
              ...
              className="bg-white dark:bg-[#0a0a0a] p-10 rounded-3xl shadow-sm border border-neutral-100 dark:border-white/10 flex flex-col items-center justify-center hover:shadow-md transition-shadow"
            >
              {prob.icon}
