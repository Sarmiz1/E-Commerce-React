...
export default function SellerLanding() {
      ...
      sections?.forEach((section, i) => {
        ...
        gsap.fromTo(section,
          { opacity: 0, y: 80 },
          {
            ...
            scrollTrigger: {
              trigger: section, start: 'top 85%', end: 'top 40%',
  ...
  return (
    <div ref={mainRef} className="min-h-screen relative selection:bg-blue-600/30"
      style={{ fontFamily: "'Inter', sans-serif", background: isDark ? '#0A0A0A' : '#ffffff', color: isDark ? '#fff' : '#111' }}>
