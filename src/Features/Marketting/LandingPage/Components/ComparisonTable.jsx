  ...
  return (
    <section ref={ref} className="py-24 bg-gray-50">
      <div className="max-w-3xl mx-auto px-6">
        ...
        <h3 className="text-4xl font-black text-center text-gray-900 mb-14">WooSho vs The Rest</h3>
        <div className="bg-white rounded-3xl shadow-xl overflow-hidden border border-gray-100">
          <div className="grid grid-cols-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-4">
            <p className="font-bold text-sm">Feature</p><p className="font-black text-center">WooSho ✨</p><p className="font-medium text-center text-blue-200 text-sm">Others</p>
          </div>
          {rows.map((row, i) => (
