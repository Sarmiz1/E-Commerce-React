...
import { Send, Plus, Search, Sparkles, ShoppingCart, User, MoreHorizontal, ArrowLeft } from 'lucide-react';
    ...
    <section className="py-24 bg-gray-50 dark:bg-[#131315] transition-colors relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-20 items-center">
        ...
        <div className="order-2 lg:order-1">
          ...
          >
            A Shopping Assistant that <span className="text-blue-600">Actually Learns.</span>
          </motion.h2>
          <p className="text-xl text-gray-600 dark:text-gray-400 mb-8 leading-relaxed">
            Stop searching and start discovering. Describe what you need in plain English, and our Neural Engine finds the perfect match across all verified sellers.
          </p>
          
          <ul className="space-y-4 mb-10">
            {["Multi-modal input (text & images)", "Budget-aware filtering", "Verified inventory only"].map((item, i) => (
              <motion.li 
                key={i}
          ...
          <button className="px-8 py-4 bg-gray-900 dark:bg-blue-600 text-white font-bold rounded-2xl hover:scale-105 active:scale-95 transition-all shadow-xl">
            Meet your Assistant
          </button>
        </div>
          ...
          <div className="w-full max-w-[400px] h-[750px] bg-white dark:bg-black rounded-[48px] border-[10px] border-gray-100 dark:border-[#1F1F23] shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)] overflow-hidden flex flex-col relative">
            ...
            <div className="p-6 flex items-center justify-between border-b border-gray-100 dark:border-white/5">
              <div className="flex items-center gap-3">
                ...
                <span className="font-bold text-xl text-gray-900 dark:text-white">Woosho</span>
              </div>
              <button className="text-blue-600 font-bold text-sm">AI Shop</button>
            </div>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8 scrollbar-hide">
              ...
              <div className="flex justify-end">
                <div className="bg-gray-100 dark:bg-white/5 px-4 py-2.5 rounded-2xl rounded-tr-none">
                  <p className="text-sm text-gray-700 dark:text-gray-300 font-medium">black sneakers under 50k</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-[10px] uppercase font-bold tracking-widest text-blue-600">Intelligence</span>
              </div>

              {/* AI Message */}
              <div className="bg-blue-50 dark:bg-blue-600/10 p-4 rounded-2xl rounded-tl-none border-l-4 border-blue-600">
                <p className="text-sm text-gray-900 dark:text-white font-medium mb-1">Got it. Showing 5 options for you.</p>
                <p className="text-[11px] text-gray-500 dark:text-gray-400">I've filtered for performance models with high durability ratings.</p>
              </div>
              ...
              >
                <div className="relative h-48 bg-gray-50 dark:bg-black/40 flex items-center justify-center p-4">
                  ...
                  <img src={shoeImg} alt="Shoe" className="h-full object-contain drop-shadow-2xl" />
                </div>
                <div className="p-5">
                  <div className="flex justify-between items-start mb-2">
                    <h4 className="font-bold text-lg text-gray-900 dark:text-white">Stealth Vector X1</h4>
            ...
            <div className="px-8 py-6 flex justify-between items-center bg-gray-50/50 dark:bg-black/50 backdrop-blur-md border-t border-gray-100 dark:border-white/5">
              <button className="text-gray-400"><Search size={22} /></button>
              <button className="text-blue-600"><Sparkles size={26} fill="currentColor" /></button>
              <button className="text-gray-400"><ShoppingCart size={22} /></button>
              <button className="text-gray-400"><User size={22} /></button>
            </div>
          </div>
        </motion.div>
      </div>
