...
const PRODUCTS = [
  { id: 1, name: 'Air Zoom Alpha', price: '₦125,000', img: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?auto=format&fit=crop&q=80&w=800' },
  { id: 2, name: 'Phantom V', price: '₦145,000', img: 'https://images.unsplash.com/photo-1605348532760-6753d2c43329?auto=format&fit=crop&q=80&w=800' },
  { id: 3, name: 'React Element', price: '₦89,000', img: 'https://images.unsplash.com/photo-1606107557195-0e29a4b5b4aa?auto=format&fit=crop&q=80&w=800' },
  { id: 4, name: 'Air Force 1 SP', price: '₦110,000', img: 'https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a?auto=format&fit=crop&q=80&w=800' },
];
  ...
  return (
    <div ref={mainRef} className="bg-[#050505] text-white min-h-screen selection:bg-blue-600/30" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="fixed top-24 left-6 z-50">
        <Link to="/brands" className="w-12 h-12 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center hover:bg-white hover:text-black transition-colors">
          <ArrowLeft size={20} />
        </Link>
      </div>
      ...
      {/* PRODUCTS GRID */}
      <section id="products-grid" className="py-24 px-6 md:px-12 max-w-[1600px] mx-auto min-h-screen">
        <div className="flex justify-between items-end mb-16">
          <h2 className="text-4xl md:text-5xl font-black uppercase tracking-tighter">Latest Releases</h2>
          <span className="text-gray-400 font-bold uppercase tracking-widest text-sm">{PRODUCTS.length} Items</span>
        </div>
          ...
          {PRODUCTS.map((product) => (
            <div key={product.id} className="product-card group cursor-pointer">
              ...
              <div className="flex justify-between items-start">
                ...
                <span className="text-lg font-bold text-gray-400">{product.price}</span>
              </div>
            </div>
          ))}
        </div>
