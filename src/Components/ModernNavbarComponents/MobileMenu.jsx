  ...
  return (
    <AnimatePresence>
      {mobileMenuOpen && (
        ...
        >
          <div className="px-6 py-6 dark:bg-black/95">
            ...
            <motion.div
              ...
              className="mt-5 flex items-center justify-between border-t border-gray-100 pt-5 dark:border-white/10"
            >
              <ThemeToggle />
              <div className="flex items-center gap-3">
                <Link
                  to="/cart"
                  onClick={() => setMobileMenuOpen(false)}
                  className="relative p-2.5 bg-gray-100 dark:bg-white/10 text-black dark:text-white rounded-xl flex items-center gap-1.5 text-sm font-bold"
                >
